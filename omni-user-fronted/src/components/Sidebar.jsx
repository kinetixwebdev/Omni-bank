...
const Sidebar = () => {
  ...
  return (
    <aside className="shrink-0 w-60 border-r h-screen border-black/10 bg-white flex flex-col justify-between">
      {/* Top Section: Logo & Main Nav */}
      <div className="flex flex-col w-full">
        {/* Brand/Logo */}
        <div className="flex items-center gap-3 p-5  border-black/5">
          <SiStarlingbank className="text-3xl text-green-500" />
